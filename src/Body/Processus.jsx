...
//   return (
//     <div className="bg-ncDarkBlue py-7 text-center text-violet-200">
//       <h2 id="processus" className="font-semibold">
//         Un processus simple et efficace
//       </h2>
//       <div
//         id="processus-container"
//         className="mx-auto flex w-[90%] gap-4 overflow-hidden"
//       >
//         <div
...
//         <button
//           className="flex size-12 items-center justify-center rounded-full border-2 border-violet-200 bg-ncDarkBlue text-2xl text-violet-200 transition-all duration-300 ease-in-out hover:border-ncPurple hover:text-ncPurple"
//           onClick={prevStep}
//         >
//           &#60;
//         </button>
