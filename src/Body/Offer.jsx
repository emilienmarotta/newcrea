export default function Offer({
  ...
  return (
    <div className="flex h-auto w-[100%] flex-col items-center justify-between gap-3 rounded-lg bg-violet-50 px-8 py-5 text-center shadow-2xl xs:w-[250px] xs:px-3 sm:w-[300px] sm:px-8">
