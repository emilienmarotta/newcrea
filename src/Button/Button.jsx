export default function Button({ text, style_ }) {
  if (style_ === 1) {
    ...
    return (
      <button className="hover:text-paletteColor3 border-paletteColor1 text-paletteColor1 hover:bg-paletteColor1 transform rounded-full border-2 bg-white px-4 py-2 transition-all duration-300 ease-in-out hover:origin-center hover:scale-105">
        {text}
      </button>
    );
  }
